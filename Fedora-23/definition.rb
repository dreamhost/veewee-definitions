...
Veewee::Session.declare({
  ...
  :iso_file => "Fedora-Server-DVD-x86_64-23.iso",
  :iso_src => "http://mirrors.rit.edu/fedora/fedora/linux/releases/23/Server/x86_64/iso/Fedora-Server-DVD-x86_64-23.iso",
  :iso_sha256 => "30758dc821d1530de427c9e35212bd79b058bd4282e64b7b34ae1a40c87c05ae",
