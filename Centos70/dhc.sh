...
/bin/sed -i 's/GRUB_CMDLINE_LINUX=.*/GRUB_TIMEOUT="vconsole.keymap=us crashkernel=auto console=tty0 console=ttyS0,115200n8 vconsole.font=latarcyrheb-sun16 rhgb quiet"/' /etc/default/grub
