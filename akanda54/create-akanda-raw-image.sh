...
PACKAGES="rsync-- git ntp python-2.7.5 py-pip wget dnsmasq bird-v6-1.3.10"
...
echo "[*] Check out the akanda-appliance repo"
git clone https://github.com/dreamhost/akanda-appliance.git
